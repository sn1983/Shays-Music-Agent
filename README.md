...
|---|---|
| `/start` | נרשם, ומקבל מיד הודעת ברוכים הבאים שכוללת **באיזו שעה יגיע העדכון היומי** — ואם שיר היום כבר פורסם, גם אותו |
...
הפקודות מופיעות בתפריט של טלגרם, ולפני שלוחצים Start מוצג תיאור שמסביר מה
מקבלים ומתי — הרצת `python main.py setup-bot` פעם אחת מפרסמת אותם.
...
| מצב | פקודה | זמן תגובה |
|---|---|---|
| GitHub Actions (ברירת מחדל) | `sync-subscribers` רץ כל 5 דקות | ~5-15 דקות |
