...
| איך מריצים | תגובה |
|---|---|
| GitHub Actions | ~5-15 דקות — `sync-subscribers` רץ כל 5 דקות |
...
המינימום ש-GitHub מאפשר, והטריגרים עצמם עלולים לאחר.

כדי שהנרשם לא ירגיש שכלום לא קרה, מפרסמים לבוט תפריט פקודות ותיאור שמופיעים לו
**מיד** כשהוא פותח את הבוט — עוד לפני Start — ומסבירים מה יקבל ושהאישור מגיע
תוך כמה דקות. צריך להריץ את זה **פעם אחת בלבד**:
