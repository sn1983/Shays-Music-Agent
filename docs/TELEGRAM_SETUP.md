...
כדי שהנרשם לא ירגיש שכלום לא קרה, הרצת **`python main.py setup-bot`** מפרסמת
תפריט פקודות ותיאור שמופיעים לו **מיד** כשהוא פותח את הבוט — עוד לפני Start —
ומסבירים מה יקבל ושהאישור מגיע תוך כמה דקות.
